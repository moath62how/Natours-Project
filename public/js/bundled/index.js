...
if (updateDataForm) updateDataForm.addEventListener("submit", (e)=>{
    ...
    console.log(form);
    (0, _updateSettingsJs.UpdateData)(form, "DATA");
});
if (updatePasswordForm) updatePasswordForm.addEventListener("submit", (e)=>{
    e.preventDefault();
    const CurrentPassword = updatePasswordForm.querySelector("#password-current").value;
    const newPassword = updatePasswordForm.querySelector("#password").value;
    const newPasswordConfirm = updatePasswordForm.querySelector("#password-confirm").value;
    (0, _updateSettingsJs.UpdateData)({
        CurrentPassword,
        newPassword,
        newPasswordConfirm
    }, "password");
...
},{"@babel/polyfill":"dTCHC","./mapBox.js":"k6XpQ","./login.js":"7yHem","./updateSettings.js":"l3cGY","./stripe.js":"10tSC"}],"dTCHC":[function(require,module,exports) {
"use strict";
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./alert.js":"kxdiQ"}],"jo6P5":[function(require,module,exports) {
...
const UpdateData = async (data, type)=>{
    try {
        ...
        const res = await (0, _axiosDefault.default).request({
            method: "patch",
            url,
            data
        });
        if (res.data.status === "success") {
            (0, _alertJs.showAlert)("success", type.toUpperCase() + " was updated successfully");
            window.setTimeout(()=>{
                location.assign("/me");
            }, 1000);
            console.log(res);
        ...
        (0, _alertJs.showAlert)("error", "There was an error updating data : " + e.message);
    }
};

},{"axios":"jo6P5","./alert.js":"kxdiQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"10tSC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alertJs = require("./alert.js");
const stripe = Stripe("pk_test_51OgFKmFBenoio41Wp2QYnkJvamgE2rTtmoDwsOsvkQkM5nUHNW7t0QIk6NFcxaGU4REH8ZDq0hDYWq0SM3FWBXN900tSEhQmBO");
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./alert.js":"kxdiQ"}]},["f2QDv"], "f2QDv", "parcelRequire11c7")
